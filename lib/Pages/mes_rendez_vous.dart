...
class MesRendezVous extends StatefulWidget {
  const MesRendezVous({super.key});

  @override
  State<MesRendezVous> createState() => _MesRendezVousState();
}

class _MesRendezVousState extends State<MesRendezVous> {
              ...
              children: [
                ...
                const Expanded(
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis, // Pour éviter le débordement
                  ),
                ),
              ],
            ),
